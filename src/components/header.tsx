...
export default function Header({ setModal }: HeaderProps) {
    return (
        <header className="min-h-screen bg-image flex flex-col items-center justify-center border-b-4 border-[#c4ecf4] px-4 pb-8">
            <div className="w-full max-w-7xl sm:grid sm:grid-cols-2 flex flex-col sm:translate-y-0 translate-y-12">
                <div className="w-full max-w-xl flex flex-col gap-8 text-white sm:text-left text-center sm:items-start items-center">
                    ...
                    <div className="flex flex-col items-center gap-8">
                        <p className="flex items-center gap-2 text-white text-xl">
                            ...
                            <span className="font-semibold">Terça-feira (19/11) ao vivo às 20h</span>
                        </p>
                        <button
            ...
            <div className="w-72 h-72 relative sm:hidden mt-20">
                <Image
                    src="/images/bg2.png"

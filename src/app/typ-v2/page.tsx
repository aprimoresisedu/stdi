          ...
          <div className="w-full max-w-xl">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col items-center gap-4 text-center text-white">
                ...
                <p>Na segunda-feira (05/05) ao vivo às 20h, você vai poder participar do Seminário: Tomada de Decisão na Intercorrência – para poder atuar de forma segura nas intercorrências, utilizando um passo a passo mental, comprovado pelas nossas +1000 alunas.</p>
              ...
              <div className="bg-zinc-100 border rounded-xl p-4 sm:p-12 flex flex-col gap-12">
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <div className="sm:max-w-xl">
                    ...
                    <div className="mt-12">
                      <a
                        href="https://chat.whatsapp.com/BrC1TtqtaHIHulP1K7cuo2"

          ...
          <div className="w-full max-w-xl">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col items-center gap-4 text-center text-white">
                ...
                <p>Na quarta-feira (21/05) ao vivo às 20h, você vai poder participar do Seminário: Tomada de Decisão na Intercorrência – para poder atuar de forma segura nas intercorrências, utilizando um passo a passo mental, comprovado pelas nossas +1000 alunas.</p>
